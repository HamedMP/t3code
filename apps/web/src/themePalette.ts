...
/**
 * The palette Matrix wears with no theme installed, captured from the app's
...
/**
 * The standard Matrix look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Matrix shows without a theme, read from the app's own
