            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Matrix could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Matrix still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
