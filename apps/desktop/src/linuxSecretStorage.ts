...
function getGnomeKeyringRemediationMessage(): string {
  return "Matrix could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Matrix.";
}

function getKWalletRemediationMessage(): string {
  return "Matrix could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Matrix.";
}
