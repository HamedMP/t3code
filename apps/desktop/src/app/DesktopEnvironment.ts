...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const userDataDirName = isDevelopment ? "matrix-dev" : "matrix";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.matrixos.desktop.dev" : "com.matrixos.desktop",
    ),
    linuxDesktopEntryName: isDevelopment ? "matrix-dev.desktop" : "matrix.desktop",
    linuxWmClass: isDevelopment ? "matrix-dev" : "matrix",
