  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Matrix prerelease is available for nightly testers."
          : "A new Matrix latest release is available.",
...
).pipe(Command.withDescription("Post a Matrix release announcement to Discord."));
